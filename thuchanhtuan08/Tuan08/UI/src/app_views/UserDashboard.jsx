...
const navItems = [
  { name: 'UserDashboard', icon: LayoutGrid, active: true },
...
export default function UserDashboard() {
  ...
  const [activeNav, setActiveNav] = useState('UserDashboard');
    ...
    <div className="flex min-h-[calc(100vh-80px)] bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex items-center justify-between px-8 py-5 bg-white border-b border-gray-100">
          <h1 className="text-2xl font-extrabold text-pink-500">UserDashboard</h1>
