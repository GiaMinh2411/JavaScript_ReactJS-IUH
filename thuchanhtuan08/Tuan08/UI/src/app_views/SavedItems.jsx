...
export default function SavedItems() {
  const [activeTab, setActiveTab] = useState('Saved ItemCatalog');

  return (
    <div className="w-full py-8 px-6 max-w-7xl mx-auto">
      {/* Breadcrumbs */}
      <div className="text-sm mb-4">
        <Link to="/" className="text-gray-500 hover:text-gray-700">MainLanding</Link>
      ...
      <div className="flex flex-wrap gap-4 mb-10 border-b border-gray-100 pb-2">
        {['Saved ItemCatalog', 'Folders', 'ItemCatalog by Genevieve'].map(tab => (
          <button
            key={tab}
